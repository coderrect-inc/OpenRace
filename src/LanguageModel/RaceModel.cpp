...
bool RaceModel::interceptCallSite(const CtxFunction<ctx> *caller, const CtxFunction<ctx> *callee,
  ...
  if (OpenMPModel::isTask(funcName)) {
        ...
        // With 2nd arg of generated task function
        // From my observation the generated task function has the signature
        // i32 (i32, %struct.kmp_task_t)
        // TODO
        // Linking kmp_task_t is not enough
        // it is a struct that can contain multiple shared variables
        // Peiming is working on linking the individual fields of kmp_task_t
...
void RaceModel::interceptHeapAllocSite(const CtxFunction<ctx> * /* caller */, const CtxFunction<ctx> * /* callee */,
                                       const llvm::Instruction * /* callsite */) {}
>>>>>>> 9fe0f0ca1dcbbd5c83eb589776c48228cac4bb4c
