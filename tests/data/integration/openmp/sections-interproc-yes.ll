...
@1 = private unnamed_addr constant [56 x i8] c";integration/openmp/sections-interproc-yes.c;main;6;1;;\00", align 1
@2 = private unnamed_addr constant [57 x i8] c";integration/openmp/sections-interproc-yes.c;main;6;30;;\00", align 1
@3 = private unnamed_addr global %struct.ident_t { i32 0, i32 2, i32 0, i32 0, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str, i32 0, i32 0) }, align 8

; Function Attrs: nounwind uwtable
define dso_local void @global_write(i32* %i) #0 !dbg !7 {
entry:
  %i.addr = alloca i32*, align 8
  store i32* %i, i32** %i.addr, align 8, !tbaa !14
  call void @llvm.dbg.declare(metadata i32** %i.addr, metadata !13, metadata !DIExpression()), !dbg !18
  %0 = load i32*, i32** %i.addr, align 8, !dbg !19, !tbaa !14
...
entry:
  ...
  %2 = bitcast i32* %shared to i8*, !dbg !29
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %2) #4, !dbg !29
  call void @llvm.dbg.declare(metadata i32* %shared, metadata !28, metadata !DIExpression()), !dbg !30
  store i32 0, i32* %shared, align 4, !dbg !30, !tbaa !21
  ...
  call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* %.kmpc_loc.addr, i32 1, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i32*)* @.omp_outlined. to void (i32*, i32*, ...)*), i32* %shared), !dbg !31
  %4 = bitcast i32* %shared to i8*, !dbg !34
...
define internal void @.omp_outlined._debug__(i32* noalias %.global_tid., i32* noalias %.bound_tid., i32* dereferenceable(4) %shared) #3 !dbg !35 {
entry:
  ...
  store i32* %shared, i32** %shared.addr, align 8, !tbaa !14
  call void @llvm.dbg.declare(metadata i32** %shared.addr, metadata !46, metadata !DIExpression()), !dbg !48
  %2 = load i32*, i32** %shared.addr, align 8, !dbg !49, !tbaa !14
...
; Function Attrs: norecurse nounwind uwtable
define internal void @.omp_outlined.(i32* noalias %.global_tid., i32* noalias %.bound_tid., i32* dereferenceable(4) %shared) #3 !dbg !62 {
entry:
  %.global_tid..addr = alloca i32*, align 8
  %.bound_tid..addr = alloca i32*, align 8
  %shared.addr = alloca i32*, align 8
  ...
  store i32* %shared, i32** %shared.addr, align 8, !tbaa !14
  call void @llvm.dbg.declare(metadata i32** %shared.addr, metadata !66, metadata !DIExpression()), !dbg !67
  %0 = load i32*, i32** %shared.addr, align 8, !dbg !68, !tbaa !14
  %1 = load i32*, i32** %.global_tid..addr, align 8, !dbg !68, !tbaa !14
  %2 = load i32*, i32** %.bound_tid..addr, align 8, !dbg !68, !tbaa !14
  %3 = load i32*, i32** %shared.addr, align 8, !dbg !68, !tbaa !14
...
!7 = distinct !DISubprogram(name: "global_write", scope: !1, file: !1, line: 1, type: !8, scopeLine: 1, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !12)
!8 = !DISubroutineType(types: !9)
!9 = !{null, !10}
!10 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !11, size: 64)
!11 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!12 = !{!13}
!13 = !DILocalVariable(name: "i", arg: 1, scope: !7, file: !1, line: 1, type: !10)
!14 = !{!15, !15, i64 0}
!15 = !{!"any pointer", !16, i64 0}
!16 = !{!"omnipotent char", !17, i64 0}
!17 = !{!"Simple C/C++ TBAA"}
!18 = !DILocation(line: 1, column: 24, scope: !7)
!19 = !DILocation(line: 1, column: 31, scope: !7)
!20 = !DILocation(line: 1, column: 33, scope: !7)
!21 = !{!22, !22, i64 0}
!22 = !{!"int", !16, i64 0}
!23 = !DILocation(line: 1, column: 37, scope: !7)
...
!26 = !{!11}
!27 = !{!28}
!28 = !DILocalVariable(name: "shared", scope: !24, file: !1, line: 4, type: !11)
!29 = !DILocation(line: 4, column: 3, scope: !24)
!30 = !DILocation(line: 4, column: 7, scope: !24)
!31 = !DILocation(line: 6, column: 1, scope: !24)
!32 = !{!33, !15, i64 16}
!33 = !{!"ident_t", !22, i64 0, !22, i64 4, !22, i64 8, !22, i64 12, !15, i64 16}
!34 = !DILocation(line: 14, column: 1, scope: !24)
!35 = distinct !DISubprogram(name: ".omp_outlined._debug__", scope: !1, file: !1, line: 7, type: !36, scopeLine: 7, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !43)
...
!46 = !DILocalVariable(name: "shared", arg: 3, scope: !35, file: !1, line: 4, type: !42)
!47 = !DILocation(line: 0, scope: !35)
!48 = !DILocation(line: 4, column: 7, scope: !35)
!49 = !DILocation(line: 7, column: 3, scope: !35)
!50 = !DILocation(line: 6, column: 1, scope: !35)
!51 = !DILocation(line: 9, column: 7, scope: !52)
!52 = distinct !DILexicalBlock(scope: !53, file: !1, line: 9, column: 5)
!53 = distinct !DILexicalBlock(scope: !35, file: !1, line: 8, column: 1)
!54 = !DILocation(line: 8, column: 20, scope: !53)
!55 = !DILocation(line: 12, column: 7, scope: !56)
!56 = distinct !DILexicalBlock(scope: !57, file: !1, line: 12, column: 5)
!57 = distinct !DILexicalBlock(scope: !35, file: !1, line: 11, column: 1)
!58 = !DILocation(line: 11, column: 20, scope: !57)
!59 = distinct !{!59, !50, !60}
!60 = !DILocation(line: 6, column: 30, scope: !35)
!61 = !DILocation(line: 13, column: 3, scope: !35)
!62 = distinct !DISubprogram(name: ".omp_outlined.", scope: !1, file: !1, line: 7, type: !36, scopeLine: 7, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !63)
!63 = !{!64, !65, !66}
...
!66 = !DILocalVariable(name: "shared", arg: 3, scope: !62, type: !42, flags: DIFlagArtificial)
!67 = !DILocation(line: 0, scope: !62)
!68 = !DILocation(line: 7, column: 3, scope: !62)
!69 = !{!70}
